const PRODUCTS = [
  {
    ...
    intro: 'Slow-roasted with groundnut oil & hand-ground Solapur masala.',
    desc: 'Our legendary chiwda — slow-roasted with groundnut oil, curry leaves & hand-ground Solapur masala. Six generations of perfection in every bite.',
    category: 'mild',
    tag: '🏆 Most Loved',
    badge: 'Bestseller',
    badgeColor: '#e07000',
    ...
    info: 'Shelf life: 75 days from the date of manufacture. No artificial colors. Groundnut oil used. 100% Vegetarian.',
    rating: 4.9,
    reviews: 284,
    featured: true,
    sortOrder: 1,
  },
  {
    ...
    info: 'Shelf life: 75 days from the date of manufacture. Best consumed fresh. 100% Vegetarian.',
    rating: 4.8,
    reviews: 218,
    featured: true,
    sortOrder: 2,
