...
//   2. Picks a "keeper": whichever has a password set, else the oldest
//      account.
...
//   4. Deletes the duplicate doc(s).
//
// This does NOT touch Orders placed under the duplicate's _id — if the
// duplicate ever placed orders as a regular customer, those stay linked
// to the old _id (harmless, just means that history won't show up under
// the merged account). Ask before running this if that matters for this
// specific email.
