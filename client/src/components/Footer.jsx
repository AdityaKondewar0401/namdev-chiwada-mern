...
const SOCIALS = [
  { slug: 'instagram', label: 'Instagram', color: 'E4405F', href: '#' },
  { slug: 'facebook', label: 'Facebook', color: '1877F2', href: '#' },
  { slug: 'youtube', label: 'YouTube', color: 'FF0000', href: '#' },
  { slug: 'whatsapp', label: 'WhatsApp', color: '25D366', href: '#' },
];
...
export default function Footer() {
  ...
  return (
    <footer className="bg-brown-dark text-white pt-10 md:pt-16 pb-10 md:pb-8">
