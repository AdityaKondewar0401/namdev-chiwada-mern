...
function TimelineItem({ item, index }) {
  ...
  return (
    <div ref={ref} className={`flex items-center gap-0 mb-16 last:mb-0 ${isLeft ? 'flex-row' : 'flex-row-reverse'}`}>
      ...
      <motion.div
        ...
        <div className="relative rounded-3xl p-7 group transition-all duration-300"
          ...
          {/* Year */}
          <div className="font-serif font-black mb-2"
          ...
          {/* Connector arrow */}
          <div className={`absolute top-1/2 -translate-y-1/2 w-0 h-0 ${isLeft ? '-right-3' : '-left-3'}`}
            style={{
              borderTop: '10px solid transparent',
              borderBottom: '10px solid transparent',
              [isLeft ? 'borderLeft' : 'borderRight']: '12px solid rgba(255,253,247,0.9)',
            }} />
        </div>
      </motion.div>
