...
export function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      // Partners now land on the normal site like any other customer —
      // their consignments/payments are one tap away via the account
      // dropdown ("My Consignments"), not a forced separate destination.
