        ...
        {addresses.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {addresses.map((a, i) => {
              ...
              return (
                <div key={i} className="p-3 rounded-xl" style={{ background: '#fef3e0' }}>
                  ...
                  <div className="flex items-center gap-2 mt-2.5">
                    ...
                    <button onClick={() => deleteAddress(i)} className="flex-1 rounded-lg text-xs font-semibold text-red-600" style={{ minHeight: 36, background: '#fff' }}>Remove</button>
                  </div>
                </div>
              );
            })}
